...
const Restaurant1 = (props) => {
    ...
    if (props.restaurants) {
        let restaurant_items = props.restaurants.rest1;
...
export default connect(mapStateToProps, mapDispatchToProps)(Restaurant1);
